...
#[path = "../git_utils.rs"]
mod git_utils;
#[path = "opencode_monitor_daemon/rpc.rs"]
mod rpc;
#[path = "../rules.rs"]
mod rules;
#[path = "../shared/mod.rs"]
...
#[path = "../storage.rs"]
mod storage;
#[path = "opencode_monitor_daemon/transport.rs"]
mod transport;
#[allow(dead_code)]
#[path = "../types.rs"]
mod types;
...
use shared::opencode_core::OpenCodeLoginCancelState;
use shared::process_core::kill_child_process_tree;
use shared::prompts_core::{self, CustomPromptEntry};
use shared::{
    agents_config_core, opencode_aux_core, opencode_core, files_core, git_core, git_ui_core,
...
struct DaemonState {
    ...
    event_sink: DaemonEventSink,
    opencode_login_cancels: Mutex<HashMap<String, OpenCodeLoginCancelState>>,
...
impl DaemonState {
    ...
    async fn add_workspace(
        ...
        workspaces_core::add_workspace_core(
            ...
            &self.app_settings,
            &self.storage_path,
            move |entry, default_bin, opencode_args, opencode_home| {
                spawn_with_client(
    ...
    async fn set_workspace_runtime_opencode_args(
        &self,
        workspace_id: String,
        opencode_args: Option<String>,
        client_version: String,
        ...
        workspaces_core::set_workspace_runtime_opencode_args_core(
            ...
            &self.sessions,
            &self.app_settings,
            move |entry, default_bin, next_args, opencode_home| {
                spawn_with_client(
                    self.event_sink.clone(),
                    client_version.clone(),
                    entry,
    ...
    async fn set_opencode_feature_flag(
        &self,
        feature_key: String,
        enabled: bool,
    ) -> Result<(), String> {
    ...
    async fn start_thread(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::start_thread_core(&self.sessions, &self.workspaces, workspace_id).await
    }
    ...
    async fn resume_thread(
        ...
        opencode_core::resume_thread_core(&self.sessions, workspace_id, thread_id).await
    }
    ...
    async fn read_thread(
        ...
        opencode_core::read_thread_core(&self.sessions, workspace_id, thread_id).await
    }
    ...
    async fn thread_live_subscribe(
        ...
        opencode_core::thread_live_subscribe_core(
            &self.sessions,
            workspace_id.clone(),
            thread_id.clone(),
        )
    ...
    async fn thread_live_unsubscribe(
        ...
        opencode_core::thread_live_unsubscribe_core(
            &self.sessions,
            workspace_id.clone(),
            thread_id.clone(),
        )
    ...
    async fn fork_thread(&self, workspace_id: String, thread_id: String) -> Result<Value, String> {
        opencode_core::fork_thread_core(&self.sessions, workspace_id, thread_id).await
    }
    ...
    async fn list_threads(
        ...
        opencode_core::list_threads_core(&self.sessions, workspace_id, cursor, limit, sort_key)
            .await
    }
    ...
    async fn list_mcp_server_status(
        ...
        opencode_core::list_mcp_server_status_core(&self.sessions, workspace_id, cursor, limit).await
    }
    ...
    async fn archive_thread(
        ...
        opencode_core::archive_thread_core(&self.sessions, workspace_id, thread_id).await
    }
    ...
    async fn compact_thread(
        ...
        opencode_core::compact_thread_core(&self.sessions, workspace_id, thread_id).await
    }
    ...
    async fn set_thread_name(
        ...
        opencode_core::set_thread_name_core(&self.sessions, workspace_id, thread_id, name).await
    }
    ...
    async fn send_user_message(
        ...
        opencode_core::send_user_message_core(
            &self.sessions,
            &self.workspaces,
            workspace_id,
            thread_id,
    ...
    async fn turn_interrupt(
        ...
        opencode_core::turn_interrupt_core(&self.sessions, workspace_id, thread_id, turn_id).await
    }
    ...
    async fn start_review(
        ...
        opencode_core::start_review_core(&self.sessions, workspace_id, thread_id, target, delivery)
            .await
    }

    async fn model_list(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::model_list_core(&self.sessions, workspace_id).await
    }
    ...
    async fn experimental_feature_list(
        ...
        opencode_core::experimental_feature_list_core(&self.sessions, workspace_id, cursor, limit)
            .await
    }

    async fn collaboration_mode_list(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::collaboration_mode_list_core(&self.sessions, workspace_id).await
    }

    async fn account_rate_limits(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::account_rate_limits_core(&self.sessions, workspace_id).await
    }

    async fn account_read(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::account_read_core(&self.sessions, &self.workspaces, workspace_id).await
    }

    async fn opencode_login(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::opencode_login_core(&self.sessions, &self.opencode_login_cancels, workspace_id).await
    }

    async fn opencode_login_cancel(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::opencode_login_cancel_core(&self.sessions, &self.opencode_login_cancels, workspace_id)
            .await
    }

    async fn skills_list(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::skills_list_core(&self.sessions, &self.workspaces, workspace_id).await
    }
    ...
    async fn apps_list(
        ...
        opencode_core::apps_list_core(&self.sessions, workspace_id, cursor, limit, thread_id).await
    }
    ...
    async fn respond_to_server_request(
        ...
        opencode_core::respond_to_server_request_core(
            &self.sessions,
            workspace_id,
            request_id,
            result,
    ...
    async fn remember_approval_rule(
        ...
        opencode_core::remember_approval_rule_core(&self.workspaces, workspace_id, command).await
    }

    async fn get_config_model(&self, workspace_id: String) -> Result<Value, String> {
        opencode_core::get_config_model_core(&self.workspaces, workspace_id).await
    }
    ...
    async fn opencode_doctor(
        &self,
        opencode_bin: Option<String>,
        opencode_args: Option<String>,
    ) -> Result<Value, String> {
        opencode_aux_core::opencode_doctor_core(&self.app_settings, opencode_bin, opencode_args).await
    }
    ...
    async fn generate_commit_message(
        ...
        opencode_aux_core::generate_commit_message_core(
            &self.sessions,
            &self.workspaces,
            workspace_id,
            &diff,
    ...
    async fn generate_agent_description(
        ...
        workspace_id: String,
        description: String,
    ) -> Result<opencode_aux_core::GeneratedAgentConfiguration, String> {
        opencode_aux_core::generate_agent_description_core(
            &self.sessions,
            &self.workspaces,
            workspace_id,
            &description,
...
fn parse_args() -> Result<DaemonConfig, String> {
    ...
    let mut token = env::var("OPENCODE_MONITOR_DAEMON_TOKEN")
        .ok()
