...
use crate::shared::opencode_core::{self, insert_optional_nullable_string};
...
pub(crate) async fn opencode_doctor(
    ...
    crate::shared::opencode_aux_core::opencode_doctor_core(&state.app_settings, opencode_bin, opencode_args)
        .await
}

#[tauri::command]
pub(crate) async fn opencode_update(
    opencode_bin: Option<String>,
    opencode_args: Option<String>,
    state: State<'_, AppState>,
) -> Result<Value, String> {
    crate::shared::opencode_update_core::opencode_update_core(&state.app_settings, opencode_bin, opencode_args)
        .await
}
...
pub(crate) async fn start_thread(
    ...
    opencode_core::start_thread_core(&state.sessions, &state.workspaces, workspace_id).await
}
...
pub(crate) async fn resume_thread(
    ...
    opencode_core::resume_thread_core(&state.sessions, workspace_id, thread_id).await
}
...
pub(crate) async fn read_thread(
    ...
    opencode_core::read_thread_core(&state.sessions, workspace_id, thread_id).await
}
...
pub(crate) async fn fork_thread(
    ...
    opencode_core::fork_thread_core(&state.sessions, workspace_id, thread_id).await
}
...
pub(crate) async fn list_threads(
    ...
    opencode_core::list_threads_core(&state.sessions, workspace_id, cursor, limit, sort_key).await
}
...
pub(crate) async fn list_mcp_server_status(
    ...
    opencode_core::list_mcp_server_status_core(&state.sessions, workspace_id, cursor, limit).await
}
...
pub(crate) async fn archive_thread(
    ...
    opencode_core::archive_thread_core(&state.sessions, workspace_id, thread_id).await
}
...
pub(crate) async fn compact_thread(
    ...
    opencode_core::compact_thread_core(&state.sessions, workspace_id, thread_id).await
}
...
pub(crate) async fn set_thread_name(
    ...
    opencode_core::set_thread_name_core(&state.sessions, workspace_id, thread_id, name).await
}
...
pub(crate) async fn collaboration_mode_list(
    ...
    opencode_core::collaboration_mode_list_core(&state.sessions, workspace_id).await
}
...
pub(crate) async fn turn_interrupt(
    ...
    opencode_core::turn_interrupt_core(&state.sessions, workspace_id, thread_id, turn_id).await
}
...
pub(crate) async fn start_review(
    ...
    opencode_core::start_review_core(
        &state.sessions,
        workspace_id,
        thread_id,
        target,
...
pub(crate) async fn model_list(
    ...
    opencode_core::model_list_core(&state.sessions, workspace_id).await
}
...
pub(crate) async fn experimental_feature_list(
    ...
    opencode_core::experimental_feature_list_core(&state.sessions, workspace_id, cursor, limit).await
}

#[tauri::command]
pub(crate) async fn set_opencode_feature_flag(
    feature_key: String,
    enabled: bool,
    state: State<'_, AppState>,
    app: AppHandle,
...
pub(crate) async fn account_rate_limits(
    ...
    opencode_core::account_rate_limits_core(&state.sessions, workspace_id).await
}
...
pub(crate) async fn account_read(
    ...
    opencode_core::account_read_core(&state.sessions, &state.workspaces, workspace_id).await
}

#[tauri::command]
pub(crate) async fn opencode_login(
    workspace_id: String,
    state: State<'_, AppState>,
    app: AppHandle,
) -> Result<Value, String> {
    ...
    opencode_core::opencode_login_core(&state.sessions, &state.opencode_login_cancels, workspace_id).await
}

#[tauri::command]
pub(crate) async fn opencode_login_cancel(
    workspace_id: String,
    state: State<'_, AppState>,
    app: AppHandle,
) -> Result<Value, String> {
    ...
    opencode_core::opencode_login_cancel_core(&state.sessions, &state.opencode_login_cancels, workspace_id)
        .await
}
...
pub(crate) async fn skills_list(
    ...
    opencode_core::skills_list_core(&state.sessions, &state.workspaces, workspace_id).await
}
...
pub(crate) async fn apps_list(
    ...
    opencode_core::apps_list_core(&state.sessions, workspace_id, cursor, limit, thread_id).await
}
...
pub(crate) async fn respond_to_server_request(
    ...
    opencode_core::respond_to_server_request_core(&state.sessions, workspace_id, request_id, result)
        .await
}
...
pub(crate) async fn remember_approval_rule(
    ...
    opencode_core::remember_approval_rule_core(&state.workspaces, workspace_id, command).await
}
...
pub(crate) async fn get_config_model(
    ...
    opencode_core::get_config_model_core(&state.workspaces, workspace_id).await
}
...
pub(crate) async fn generate_commit_message(
    ...
    crate::shared::opencode_aux_core::generate_commit_message_core(
        &state.sessions,
        &state.workspaces,
        workspace_id,
        &diff,
...
pub(crate) async fn generate_run_metadata(
    ...
    crate::shared::opencode_aux_core::generate_run_metadata_core(
        &state.sessions,
        &state.workspaces,
        workspace_id,
        &prompt,
...
pub(crate) async fn generate_agent_description(
    ...
    state: State<'_, AppState>,
    app: AppHandle,
) -> Result<crate::shared::opencode_aux_core::GeneratedAgentConfiguration, String> {
    if remote_backend::is_remote_mode(&*state).await {
        let value = remote_backend::call_remote(
            &*state,
            app,
    ...
    crate::shared::opencode_aux_core::generate_agent_description_core(
        &state.sessions,
        &state.workspaces,
        workspace_id,
        &description,
