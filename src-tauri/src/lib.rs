...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            opencode::start_thread,
            opencode::send_user_message,
            opencode::turn_steer,
            opencode::turn_interrupt,
            opencode::start_review,
            opencode::respond_to_server_request,
            opencode::remember_approval_rule,
            opencode::generate_commit_message,
            opencode::generate_run_metadata,
            opencode::generate_agent_description,
            opencode::resume_thread,
            opencode::read_thread,
            opencode::thread_live_subscribe,
            opencode::thread_live_unsubscribe,
            opencode::fork_thread,
            opencode::list_threads,
            opencode::list_mcp_server_status,
            opencode::archive_thread,
            opencode::compact_thread,
            opencode::set_thread_name,
            opencode::collaboration_mode_list,
            ...
            opencode::model_list,
            opencode::experimental_feature_list,
            opencode::set_opencode_feature_flag,
            opencode::get_agents_settings,
            opencode::set_agents_core_settings,
            opencode::create_agent,
            opencode::update_agent,
            opencode::delete_agent,
            opencode::read_agent_config_toml,
            opencode::write_agent_config_toml,
            opencode::account_rate_limits,
            opencode::account_read,
            opencode::opencode_login,
            opencode::opencode_login_cancel,
            opencode::skills_list,
            opencode::apps_list,
